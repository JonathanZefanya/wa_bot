...
name="Jonathan ITI" #The bot will consider this person as its owner or creator
bot_name="Nahida" #This will be the name of your bot, eg: "Hello I am Astro Bot"
            ...
            if data["type"] == "text":
                ...
                if data["type"] == "audio":
                    ...
                    for _,page in enumerate(doc):
                        ...
                        send(convo.last.text)
                        remove(destination)
                else:send("Kamu pasti mengirim hal yang aneh ☹")
